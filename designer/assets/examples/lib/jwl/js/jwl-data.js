/*
	JWL - The JavaScript Widget Library version 0.8.1 testing
...
JUL.apply(JWL.components.playerbar, /** @lends JWL.components.playerbar */ {
	...
	*/
	...
	/**
		...
		@type	Array|String
	*/
	css: ['../../assets/examples/lib/faws/css/font-awesome.min.css?v=0.8.1',
	 '../../assets/examples/lib/jwl/css/playerbar.css?v=0.8.1']
});
...
JUL.apply(JWL.components.jsonoptions, /** @lends JWL.components.jsonoptions */ {
	...
	*/
	css: ['../../assets/examples/lib/faws/css/font-awesome.min.css?v=0.8.1',
	 '../../assets/examples/lib/jwl/css/jsonoptions.css?v=0.8.1']
});
...
JUL.apply(JWL.components.frameplayer, /** @lends JWL.components.frameplayer */ {
	...
	*/
	...
	/**
		...
		@type	Array|String
	*/
	css: '../../assets/examples/lib/jwl/css/frameplayer.css?v=0.8.1'
});

...
/*
  ...
  Version v10.0p_2014-10-28/LGPL Deployment (2014-10-28)
...
if (window.isc && isc.version != "v10.0p_2014-10-28/LGPL Deployment") {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v10.0p_2014-10-28/LGPL Deployment'. Mixing resources from different "
...
isc.TimelineView.addProperties({
    ...
    cellMouseDown : function (record, rowNum, colNum) {
        ...
        p[cal.laneNameField] = lane;
        p[cal.sublaneNameField] = sublane;

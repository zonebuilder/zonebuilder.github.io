...
isc.version = "v10.0p_2014-10-28/LGPL Deployment";
isc.versionNumber = "v10.0p_2014-10-28";
isc.buildDate = "2014-10-28";
isc.expirationDate = "";
...
isc.hasOptionalModule = function (module) {
    ...
    switch (module) {
        case "Analytics":         return isc.isA.Class(isc.CubeGrid);
        case "RealtimeMessaging": return isc.isA.Class(isc.Messaging);
    }
